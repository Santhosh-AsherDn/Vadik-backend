...
exports.changePassword = async (req, res) => {
  try {
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.6;">
      <h2 style="color: #333;">Hello ${retailer.name || retailer.email},</h2>
...
exports.sendResetLink = async (req, res) => {
  ...
  // await sendMail(email, "Password Reset", `Click to reset: ${resetLink}`);
  ...
  await sendMail(
    ...
    `
    <div style="font-family: Arial, sans-serif; line-height: 1.6;">
      <h2 style="color: #333;">Hi ${retailer.name || retailer.email},</h2>
